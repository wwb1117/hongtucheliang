<template>
    <el-container id="terminalManageWrap" class="fun_wrap fun_content_wrap" v-bind:style="{height: wrapHeight + 'px',position: 'relative'}">
        <el-header>
            <div class="searbox_wrap">
                <div class="searFormRow">
                    <el-row class="sear_box">
                        <div :style="{'float':'left'}">
                            <el-form :inline="true" size="small" ref="form" :model="terminalManageSearParam" :rules="rules">
                                ...
                                <el-form-item label="终端生产厂商" prop="factoryName" verify can-be-empty VerifyNumABCZh>
                                    <el-input class="sear_input" v-model="terminalManageSearParam.factoryName" clearable></el-input>
                                </el-form-item>
                                <el-form-item label="SIM卡号" prop="actualSimNo" verify can-be-empty VerifySimNo>
                ...
                <el-row :span="24" class="btnGroupRow">
                    ...
                    <el-col :span="8.5" :style="{'float':'right','margin-right':'30px', position:'relative'}">
                        ...
                        <div :style="{position: 'absolute', right: '-7px', top: '45px'}">
                            <el-popover
                                ref="setTableCol"
        ...
        <el-main v-bind:class="[isSupActive ? 'heigthnormal' : 'heigthadd']">
            <el-table ref="terminalManagetable" @row-click="rowClickEvent" :model="form" @selection-change="tableSelectChange"  :data="terminalManageTab" :height="tableHeight" tooltip-effect="dark" :stripe="true" size="mini" highlight-current-row :border="true">
                ...
                <el-table-column :show-overflow-tooltip="showTipFlg" width="50" header-align="left" type="index" label="序号"></el-table-column>
         		<el-table-column v-if="isTableCellShow('tboxId')" :show-overflow-tooltip="showTipFlg" width="120" header-align="left" prop="tboxId" label="终端号">
                ...
                <el-table-column v-if="isTableCellShow('actualSimNo')" :show-overflow-tooltip="showTipFlg" width="120" header-align="left" prop="actualSimNo" label="实际SIM卡号"></el-table-column>
                <el-table-column v-if="isTableCellShow('iccid')" :show-overflow-tooltip="showTipFlg" width="120" header-align="left" prop="iccid" label="ICCID"></el-table-column>
                ...
                <el-table-column v-if="isTableCellShow('factoryName')" :show-overflow-tooltip="showTipFlg" width="100" header-align="left" prop="factoryName" label="终端生产厂商"></el-table-column>
                <el-table-column v-if="isTableCellShow('tboxModel')" :show-overflow-tooltip="showTipFlg" width="100" header-align="left" prop="tboxModel" label="终端型号"></el-table-column>
                <el-table-column v-if="isTableCellShow('tboxVer')" :show-overflow-tooltip="showTipFlg" width="100" header-align="left" prop="tboxVer" label="终端版本号"></el-table-column>
                <el-table-column v-if="isTableCellShow('carVin')" :show-overflow-tooltip="showTipFlg" header-align="left" prop="carVin" label="VIN码"></el-table-column>
                <el-table-column v-if="isTableCellShow('carNo')" :show-overflow-tooltip="showTipFlg" header-align="left" prop="carNo" label="车牌号"></el-table-column>
                <el-table-column v-if="isTableCellShow('produceDate')" :show-overflow-tooltip="showTipFlg" header-align="left" prop="produceDate" label="生产日期"> </el-table-column>
                <el-table-column v-if="isTableCellShow('buyDate')" :show-overflow-tooltip="showTipFlg" header-align="left" prop="buyDate" label="购买日期"> </el-table-column>
                <el-table-column v-if="isTableCellShow('expireDate')" :show-overflow-tooltip="showTipFlg" header-align="left" prop="expireDate" label="保修截止日期"> </el-table-column>
            </el-table>
        </el-main>
        ...
        <!-- 导入 -->
        <el-dialog id="terminalImportWin" class="import_win" :close-on-click-modal="false" v-drag="{width:640,height:372}" :title="winTitle" @close="closeImportWindow" :visible.sync="importDialogFormVisible" width="640px">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.tableHeight = this.wrapHeight - 203;
            // this.getTableCellSetList()
            this.GLOBAL.getTableCellSetList('terminalManage', this.tableCellList).then((res) => {
                this.checkList = res
            })
            this.getTableData();
            this.getFactoryName();
        ...
        methods: {
            tableCellCloseEvent(){
                this.GLOBAL.tableCellCloseEvent('terminalManage', this.tableCellKeyVal, this.checkList)
            },
            isTableCellShow(val){
            ...
            handleCheckAllChange(val){
                ...
                window.setTimeout(function(){
                    $('#terminalManageWrap .el-table__body-wrapper').height(that.tableHeight - 40)
                }, 200)
            },
           ...
           //触发点击不同的表格项获取当前
            ...
            exportEvent(){
                ...
                var totalData = {
                    ...
                    carVin: this.terminalManageSearParam.carVin,
                    install: this.terminalManageSearParam.install,
                    headers: '终端号,SIM卡号,ICCID,终端生产厂商,终端型号,终端版本号,VIN码,车牌,生产日期,购买日期,保修截止日期,备注',
